            ...
            'session_manager' => function($serviceManager)
                {
                    ...
                    $sessionTableGateway    =   new Zend\Db\TableGateway\TableGateway( 'sessions', $dbAdapter );                                                                                        
                    $sessionGateway         =   new Zend\Session\SaveHandler\DbTableGateway( $sessionTableGateway, $sessionOptions );                                                                                        
